...
**Сообщение ограничено.** Не больше 30 issue в списке, остальные сворачиваются в
счётчик, длинные строки обрезаются. Без этого один аномально длинный стектрейс
даёт сообщение сверх лимита Telegram, а неретраибельная ошибка доставки вешает
дайджест насмерть.
